                ...
                <tbody>
                  ...
                  <tr>
				   ...
				   <?php 
                    ...
                    <td>
                      <div class="btn-group">
                          <input type="button" onclick="window.location.href='index.php?action=ReponsServiceU&id_service=<?= $row[4] ?>'" value="Répondre" class="btn btn-primary" style="width:110px;"/>
                      </div>
                    </td>
