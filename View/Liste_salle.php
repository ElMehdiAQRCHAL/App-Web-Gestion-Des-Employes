          ...
          <div class="col-lg-12" >
			...
			<div class="nav search-row" id="top_menu">
				...
				<ul class="nav top-menu">
				  <li>
					<form class="navbar-form" role="form" action="index.php?action=Liste_salle" method="POST">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form role="form" action="index.php?action=Ajouter_Salle" method="POST" name = "myForm">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form role="form" action="index.php?action=Supprimer_Salle&a=Liste_salle" method="POST">
                            <div class="form-group">
		...
		$(document).ready(function(){
			...
			*********************************************************************************/
			...
			//***************************
			   ...
			   xhr.open( "GET", "index.php?action=testerSalle&numero=" + document.myForm.numero.value,  true); 
