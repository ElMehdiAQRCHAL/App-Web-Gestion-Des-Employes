        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
			  ...
			  <li><i class="fa fa-user" aria-hidden="true"></i>Professeur</li>
            </ol>
          </div>
        </div
          ...
          <div class="col-lg-12" >
			...
			<div class="nav search-row" id="top_menu">
				...
				<ul class="nav top-menu">
				  <li>
					<form class="navbar-form" role="form" action="index.php?action=Liste_Professeur" method="POST">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form role="form" action="index.php?action=Ajouter_Professeur" method="POST" name = "myForm">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form role="form" action="index.php?action=Supprimer_Utilisateur&a=Liste_Professeur" method="POST">
                            <div class="form-group">
								<input type="hidden" name="delete_user" id="delete_user">
								<h4>Voulez-vous supprimer ce professeur</h4>
							</div>
